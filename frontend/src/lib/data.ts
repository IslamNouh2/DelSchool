...
export const items = [
    ...
    },
    {
        ...
        icon: PersonStanding,
        subItems: [
            { title: "All Student", href: "" },
            { title: "Ajouter Student", href: "" },
        ],
        role: "admin,teacher",
    },
    {
        ...
        icon: Calendar,
        subItems: [
            { title: "My Calendar", href: "" },
            { title: "Team Events", href: "" },
        ],
    },
];
...
function setTimeOnDay(dayOffset: number, hours: number, minutes: number): Date {
    const base = new Date();
...
export const calendarEvents = [
    // Day 1 (Today)
    { title: "Math", allDay: false, start: setTimeOnDay(0, 8, 0), end: setTimeOnDay(0, 8, 45) },
    { title: "English", allDay: false, start: setTimeOnDay(0, 9, 0), end: setTimeOnDay(0, 9, 45) },
    { title: "Biology", allDay: false, start: setTimeOnDay(0, 10, 0), end: setTimeOnDay(0, 10, 45) },
    { title: "Physics", allDay: false, start: setTimeOnDay(0, 11, 0), end: setTimeOnDay(0, 11, 45) },
    { title: "Chemistry", allDay: false, start: setTimeOnDay(0, 13, 0), end: setTimeOnDay(0, 13, 45) },
    { title: "History", allDay: false, start: setTimeOnDay(0, 14, 0), end: setTimeOnDay(0, 14, 45) },

    // Day 2 (Tomorrow)
    { title: "Math", allDay: false, start: setTimeOnDay(1, 8, 0), end: setTimeOnDay(1, 8, 45) },
    { title: "English", allDay: false, start: setTimeOnDay(1, 9, 0), end: setTimeOnDay(1, 9, 45) },
    { title: "Biology", allDay: false, start: setTimeOnDay(1, 10, 0), end: setTimeOnDay(1, 10, 45) },
    { title: "History", allDay: false, start: setTimeOnDay(1, 14, 0), end: setTimeOnDay(1, 14, 45) },

    // Day 3
    { title: "Math", allDay: false, start: setTimeOnDay(2, 8, 0), end: setTimeOnDay(2, 8, 45) },
    { title: "English", allDay: false, start: setTimeOnDay(2, 9, 0), end: setTimeOnDay(2, 9, 45) },
    { title: "Physics", allDay: false, start: setTimeOnDay(2, 11, 0), end: setTimeOnDay(2, 11, 45) },
    { title: "Chemistry", allDay: false, start: setTimeOnDay(2, 13, 0), end: setTimeOnDay(2, 13, 45) },

    // Day 4
    { title: "Biology", allDay: false, start: setTimeOnDay(3, 10, 0), end: setTimeOnDay(3, 10, 45) },
    { title: "History", allDay: false, start: setTimeOnDay(3, 14, 0), end: setTimeOnDay(3, 14, 45) },

    // Day 5
    { title: "English", allDay: false, start: setTimeOnDay(4, 9, 0), end: setTimeOnDay(4, 9, 45) },
    { title: "Physics", allDay: false, start: setTimeOnDay(4, 11, 0), end: setTimeOnDay(4, 11, 45) },
    { title: "Chemistry", allDay: false, start: setTimeOnDay(4, 13, 0), end: setTimeOnDay(4, 13, 45) },
];
