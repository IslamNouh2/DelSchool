                    ...
                    <SheetHeader className="text-left relative z-10">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-blue-100 font-bold text-xs uppercase tracking-widest mt-1 opacity-80">
                ...
                <div className="flex-1 overflow-y-auto p-10 space-y-8 custom-scrollbar dark:bg-slate-950/20">
                    {loading ? (
                        <div className="flex flex-col items-center justify-center py-20 gap-4">
                            ...
                            <p className="text-[10px] font-black uppercase text-blue-900 dark:text-blue-200 tracking-widest animate-pulse">Synchronisation des registres...</p>
                        </div>
                    ) : history.length > 0 ? (
                            ...
                            {history.map((item, idx) => {
                                ...
                                return (
                                    <div key={idx} className="relative pl-10 animate-in slide-in-from-left-4 duration-500" style={{ animationDelay: `${idx * 50}ms` }}>
                                        <div className={cn(
                                            "absolute left-0 top-1 w-6 h-6 rounded-full flex items-center justify-center ring-4 ring-white dark:ring-slate-900 shadow-md z-10",
                                        ...
                                        <div className="group bg-white dark:bg-slate-900 rounded-[1.75rem] border border-gray-100 dark:border-slate-800 p-5 shadow-sm hover:shadow-xl dark:hover:shadow-blue-950/20 hover:border-blue-100 dark:hover:border-blue-900/50 transition-all duration-300">
                                            <div className="flex justify-between items-start mb-2">
                                                <span className={cn(
                                                    ...
                                                    {isFee ? "Frais Créé" : "Paiement Reçu"}
                                                </span>
                                            ...
                                            <h4 className="text-lg font-black text-gray-900 dark:text-gray-100 tracking-tight leading-tight">
                        ...
                        <div className="text-center py-20 bg-gray-50/50 dark:bg-slate-900/50 rounded-[3rem] border-2 border-dashed border-gray-100 dark:border-slate-800 flex flex-col items-center gap-4">
                            ...
                            <p className="text-[10px] font-black uppercase text-gray-300 dark:text-slate-600 tracking-widest">Aucune transaction enregistrée</p>
                        </div>
                    )}
                </div>
            </SheetContent>
