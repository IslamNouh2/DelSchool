...
type FormModalProps = {
    table: "student" | "local" | "class" | "subject" | "employer";
    type: "create" | "update";
    data?: any;
    relatedData?: any;
    onSuccess?: () => void;
...
const FormModal: React.FC<FormModalProps> = ({
    ...
    const renderForm = () => {
        switch (table) {
            ...
            case "subject":
                return <SubjectForm type={type} data={data} open={open} onOpenChange={setOpen} onSuccess={onSuccess} />;
            case "employer":
                return <EmployerForm type={type} data={data} open={open} onOpenChange={setOpen} onSuccess={onSuccess} />;
            default:
        ...
        <>
            ...
            {open && (
                <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
                    <div className="bg-card p-4 rounded-md relative w-[90%] md:w-[70%] lg:w-[50%]">
                        {renderForm()}
                        <div
