...
let SubjectService = class SubjectService {
    ...
    async create(tenantId, createSubjectDto) {
    ...
    async findSubSubjects(tenantId) {
    ...
    async findAll(tenantId, page = 1, limit = 10, orderByField = 'dateCreate', name, status) {
    ...
    async update(tenantId, subjectId, updateDto) {
