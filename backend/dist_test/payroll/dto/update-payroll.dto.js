...
class UpdatePayrollDto extends (0, swagger_1.PartialType)(create_payroll_dto_1.CreatePayrollDto) {
    status;
}
exports.UpdatePayrollDto = UpdatePayrollDto;
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: client_1.PayrollStatus, example: client_1.PayrollStatus.APPROVED }),
